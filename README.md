...
![blueprint screenshot](https://github.com/patrick-hignell/spaceship-builder/blob/main/public/images/screenshot1.png?raw=true)
...
![blueprint 2 screenshot](https://github.com/patrick-hignell/spaceship-builder/blob/main/public/images/screenshot2.png?raw=true)

There is currently several rooms to choose from including corridors, stairs, corners and t-junctions.

![thruster screenshot](https://github.com/patrick-hignell/spaceship-builder/blob/main/public/images/screenshot4.png?raw=true)
...
![ship interior screenshot](https://github.com/patrick-hignell/spaceship-builder/blob/main/public/images/screenshot3.png?raw=true)

The player can enter the ship, triggering the player to transition from free floating to ship gravity.

![wire screenshot](https://github.com/patrick-hignell/spaceship-builder/blob/main/public/images/screenshot5.png?raw=true)

Wires can be picked up and extended from the ships helm and then attached to the internal nodes of the thrusters.

![wire thruster screenshot](https://github.com/patrick-hignell/spaceship-builder/blob/main/public/images/screenshot6.png?raw=true)

The color of each wire identifies which helm output is connected to which thruster.

![wire renderer screenshot](https://github.com/patrick-hignell/spaceship-builder/blob/main/public/images/screenshot7.png?raw=true)
...
![helm screenshot](https://github.com/patrick-hignell/spaceship-builder/blob/main/public/images/screenshot8.png?raw=true)

When the player is at the helm the player can then activate different wires depending on which key is pressed.

![ship movement screenshot](https://github.com/patrick-hignell/spaceship-builder/blob/main/public/images/screenshot9.png?raw=true)
...
![ship movement 2 screenshot](https://github.com/patrick-hignell/spaceship-builder/blob/main/public/images/screenshot10.png?raw=true)

Currently you can move between several small planets at high speeds.

![asteroid screenshot](https://github.com/patrick-hignell/spaceship-builder/blob/main/public/images/screenshot11.png?raw=true)
...
![asteroid 2 screenshot](https://github.com/patrick-hignell/spaceship-builder/blob/main/public/images/screenshot12.png?raw=true)
